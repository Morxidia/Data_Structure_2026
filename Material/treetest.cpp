// Source - https://stackoverflow.com/a/36810117
// Posted by Christopher Oicles, modified by community. See post 'Timeline' for change history
...
int main() {
    ...
    // Build OP's tree
    bt.insert(8,5,2,6,10,9,11.19,21,34,56,1,9,7,11);
    cout << "Tree from OP:\n\n";
    bt.Dump();
    cout << "\n\n";
